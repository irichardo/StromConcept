  ...
  return (
    <>
      <nav className='w-screen h-[10%] fixed flex bg-[#0b532a]'>
        <div className='w-3/6 h-full text-center flex items-center justify-end'> <Image src='/logo.png' width={120} height={60} alt='strong de la empresa logo' /></div>
      ...
      <nav className='w-screen'>
        ...
        <div className='w-full h-[10%] bg-[#0F783D] text-white text-sm shadow-sm shadow-green-950 fixed z-20 hidden sm:flex'>
          {/* LOGO */}
          <div className='w-1/5 text-center flex items-center justify-end'> <Image src='/logo.png' width={120} height={60} alt='strong de la empresa logo' className='m-4' /></div>
